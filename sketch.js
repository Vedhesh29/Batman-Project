...
function preload(){
    ...
    thun1 = loadImage("thunderbolt1.png");
    thun2 = loadImage("thunderbolt2.png");
    thun3 = loadImage("thunderbolt3.png");
    thun4 = loadImage("thunderbolt4.png");
}
...
function draw(){
    ...
    Engine.update(engine);
      ...
      if(frameCount%80===0){
          ...
          thun = createSprite(random(10,370), random(10,30), 50, 50);
          switch(rand){
